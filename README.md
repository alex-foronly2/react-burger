...
Использовал github pages поскольку не было возможности привязать карту, а без этого задеплоить на Yandex Cloud не получится: 
https://alex-foronly2.github.io/react-burger/
